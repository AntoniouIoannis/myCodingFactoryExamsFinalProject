...
/****** Object:  Table [dbo].[MUSEUMS]    Script Date: 18/1/2025 19:55:53 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE MUSEUMS
ADD mus_open NVARCHAR(50) NULL;
GO

EXEC sp_rename 'MUSEUMS.msm_lati', 'mus_lati', 'COLUMN';
GO
