...
/****** Object:  Table [dbo].[MUSEUMS]    Script Date: 19/1/2025 01:43:10 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[MUSEUMS](
	...
	[mus_lati] [geography] NULL,
	[mus_long] [geography] NULL,
	[mus_avg_rate] [tinyint] NULL,
	[mus_open] [nvarchar](50) NULL,
...
ALTER TABLE [dbo].[MUSEUMS]
ADD mus_coordination GEOGRAPHY NULL;
GO